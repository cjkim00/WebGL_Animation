...
function createConnecterGear(numTeeth, numSpokes) {
    const vertices = [];
    const colors = [];
    const normals = [];
    ...
    var outRad = 1.12; //controls the length of the teeth
    ...
    var i;
    var temp = rad * 1.1;//circle outer edge
    var innerEdge = 1.02;//circle inner edge
