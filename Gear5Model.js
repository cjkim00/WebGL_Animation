...
function create5Gear(numTeeth, numSpokes) {
    const vertices = [];
    const colors = [];
    const normals = [];
    ...
    var outRad = 1.24; //controls the length of the teeth
    var angInc = 2 * 3.14159 / n;//controls the % of the circle
    var ang = 0;
    var z = 0.1;

    var i;
    var temp = rad * 1.22;//circle outer edge
    var innerEdge = 1.12;//circle inner edge
